...
public class SwerveCommands {
    ...
    public TuneableCommand controller(DoubleSupplier forwardSupplier, DoubleSupplier sidewaysSupplier,
        ...
        return new SwerveController(swerve, forwardSupplier, sidewaysSupplier, rotationSupplier, isFieldRelativeSupplier);
    }

    public Command controlModules(DoubleSupplier steerXSupplier, DoubleSupplier steerYSupplier,
